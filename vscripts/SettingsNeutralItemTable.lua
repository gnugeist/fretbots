...
{ 
	...
	-- Tier 1 Neutrals                                           					   roles= 1,2,3,4,5
	...
	{name = 'item_mysterious_hat',					tier = 1, ranged = 1, 	melee = 1,		roles={1,2,1,1,1}, realName = "Fairy's Trinket"},	
	...
	{name = 'item_seeds_of_serenity',				tier = 1, ranged = 1, 	melee = 1,		roles={1,1,1,1,1}, realName = "Seeds of Serenity"},	
	...
	{name = 'item_duelist_gloves',					tier = 1, ranged = 1, 	melee = 1,		roles={1,1,3,2,2}, realName = "Duelist Gloves"},
	...
	{name = 'item_spark_of_courage',				tier = 1, ranged = 1, 	melee = 1,		roles={1,1,3,2,2}, realName = "Spark of Courage"},
	...
	{name = 'item_vampire_fangs',					tier = 2, ranged = 1, 	melee = 1,		roles={1,2,2,0,0}, realName = 'Vampire Fangs'},
  ...
  --{name = 'item_paintball',							tier = 2, ranged = 1, 	melee = 1,		roles={2,2,1,1,1}, realName = 'Fae Grenade'},	
	...
	{name = 'item_orb_of_destruction', 		tier = 2, ranged = 1, 	melee = 1,		roles={1,2,1,0,0}, realName = 'Orb of Destruction'},
	{name = 'item_gossamer_cape', 		tier = 2, ranged = 1, 	melee = 1,		roles={1,1,1,1,1}, realName = 'Gossamer Cape'},
	...
	{name = 'item_elven_tunic', 					tier = 3, ranged = 1, 	melee = 1,		roles={3,4,3,2,2}, realName = 'Elven Tunic'},
	{name = 'item_cloak_of_flames', 			tier = 3, ranged = 1, 	melee = 2,		roles={2,2,6,2,2}, realName = 'Cloak of Flames'},
	{name = 'item_ceremonial_robe', 			tier = 3, ranged = 1, 	melee = 1,		roles={1,1,1,6,5}, realName = 'Ceremonial Robe'},
	{name = 'item_psychic_headband', 			tier = 3, ranged = 3, 	melee = 1,		roles={1,1,1,5,6}, realName = 'Psychic Headband'},
	...
	{name = 'item_dandelion_amulet', 		tier = 3, ranged = 1, 	melee = 1,		roles={0,0,3,2,2}, realName = 'Dandelion Amulet'},
	{name = 'item_defiant_shell', 		tier = 3, ranged = 1, 	melee = 1,		roles={0,1,1,0,0}, realName = 'Defiant Shell'},
	{name = 'item_vindicators_axe', 		tier = 3, ranged = 1, 	melee = 1,		roles={1,2,3,1,0}, realName = "Vindicator's Axe"},
  ...
  {name = 'item_spy_gadget', 						tier = 4, ranged = 2, 	melee = 0,		roles={0,0,0,3,3}, realName = 'Telescope'},	
	...
	{name = 'item_martyrs_plate', 					tier = 4, ranged = 1, 	melee = 1,		roles={0,0,4,0,0}, realName = "Martyr's Plate"},
